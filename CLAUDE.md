...
- `WebTools` — exposes web search functionality as an AI-callable tool. Registered as the `"web-search"` tool group. Returns a "disabled" message if `BRAVE_SEARCH_API_KEY` is absent.
