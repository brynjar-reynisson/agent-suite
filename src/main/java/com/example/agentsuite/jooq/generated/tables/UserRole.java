...
public class UserRole extends TableImpl<UserRoleRecord> {
     ...
     */
    public final TableField<UserRoleRecord, String> ROLE = createField(DSL.name("role"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.user_role.granted_at</code>.
     */
    public final TableField<UserRoleRecord, OffsetDateTime> GRANTED_AT = createField(DSL.name("granted_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    public SuiteUserPath suiteUser() {
        if (_suiteUser == null)
            _suiteUser = new SuiteUserPath(this, Keys.USER_ROLE__USER_ROLE_USER_ID_FKEY, null);
